...
( owner                 varchar2(30)    not null,    
  ...
  auto_sample_size      varchar2(5)     default 'FALSE',
  estimate_percent      number(9,6)     default null,
  block_sample          varchar2(5)     default 'FALSE',
  method_opt            varchar2(250)   default 'FOR ALL COLUMNS SIZE 1',
  default_degree        varchar2(5)     default 'FALSE',
  degree                number(2)       default NULL,
  granularity           varchar2(12)    default 'DEFAULT',
  cascade               varchar2(5)     default 'FALSE',
  no_invalidate         varchar2(5)     default 'FALSE',
  ...
  check(default_degree in ('TRUE', 'FALSE')),
  check(granularity in ('DEFAULT', 'SUBPARTITION', 'PARTITION', 'GLOBAL', 'ALL')),
