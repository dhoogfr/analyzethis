...
/*
  You can now setup a job to automate the gather stats (see job_example.sql for an example). 
  Don't forget to run the DBMS_STATS.ALTER_SCHEMA_TAB_MONITORING procedure for the schema's 
  for which you want to automate the statistics gathering
*/
