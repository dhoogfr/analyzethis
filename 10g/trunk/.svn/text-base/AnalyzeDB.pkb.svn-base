...
-----------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        <MODIFICATIONS>
            <MODIFICATION>
                ...
                <AUTHOR> Freek D'Hooge </AUTHOR>
                <WHAT> removed the option to include/exclude the sys schema
                       and added a filter on dictionary schema's.
                       These schema's should be analyzed via the dbms_stats.gather_dictionary_stats project.
                </WHAT>
            </MODIFICATION>
        </MODIFICATIONS>
*/
    ...
    BEGIN
        ...
        debug.f('Opening the ref cursor to get all the schema''s with objects, filtering out dictionary schemas');
